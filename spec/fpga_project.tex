...
\verb|software/c_test/c_test.c|, \verb|software/strcmp/strcmp.c|, \verb|software/vecadd/vecadd.c|,
...
Remember that whenever you change a source file, click \textbf{Refresh Changed Modules} so that the changes take effective when you implement your design the next time. Also note that we only need to run the script \verb|init-arm| whenever a new clock is applied (and hence a new set of ps7 files), or the board is just turned on.
