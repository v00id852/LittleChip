...
%
%\begin{minted}{bash}
%# If you are programming the FPGA from a lab machine with the Hardware Server, make sure that you update the port number in \verb|hardware/scripts/init_arm.tcl| to your assigned port number).
%make init-arm
%\end{minted}
%
%This command will 
...
\begin{itemize}
\item Sketch the block diagram of your accelerator design. What memory or compute optimizations would you like to highlight in your design?
