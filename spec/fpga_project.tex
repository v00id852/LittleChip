...
\item pool1\_ofm: \verb|0xffffdef0|
\item conv2\_ofm: \verb|0xff41e211|
\item pool2\_ofm: \verb|0xfffff629|
\item fc\_ofm: \verb|0xb827b474|
\end{itemize}
...
(You should think of an approach that introduces the \textit{least impact} to your existing processor pipeline, and requires the minimal effort when actually implementing it.)
